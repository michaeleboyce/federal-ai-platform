...
TEMPLATES = [
    ...
    ("Analyzing documents for redaction or privacy review using AI.",
     "redaction", "privacy"),
    ("Translating text or speech using AI.",
     "translation", "writing"),
    ("Detecting threats or anomalies using AI.",
     "threat_detection", "cybersecurity"),
    ("Managing or implementing security controls using AI.",
     "security_controls", "cybersecurity"),
    ("Audio transcription.",
     "audio_transcription", "meetings"),
    ("Spelling, grammar, and plagiarism check.",
     "spelling_grammar", "writing"),
]
